...
ax.set_xlabel("Координата в шагах JetMover")
...
adc0mm = np.loadtxt("C:\\Users\\Askar\\PycharmProjects\\pythonProject\\0mm.txt", dtype=int)
adc10mm = np.loadtxt("C:\\Users\\Askar\\PycharmProjects\\pythonProject\\10mm.txt", dtype=int)
adc20mm = np.loadtxt("C:\\Users\\Askar\\PycharmProjects\\pythonProject\\20mm.txt", dtype=int)
adc30mm = np.loadtxt("C:\\Users\\Askar\\PycharmProjects\\pythonProject\\30mm.txt", dtype=int)
adc40mm = np.loadtxt("C:\\Users\\Askar\\PycharmProjects\\pythonProject\\40mm.txt", dtype=int)
adc50mm = np.loadtxt("C:\\Users\\Askar\\PycharmProjects\\pythonProject\\50mm.txt", dtype=int)
adc60mm = np.loadtxt("C:\\Users\\Askar\\PycharmProjects\\pythonProject\\60mm.txt", dtype=int)
adc70mm = np.loadtxt("C:\\Users\\Askar\\PycharmProjects\\pythonProject\\70mm.txt", dtype=int)
...
q_0 = (2 * 3.14 * 1.2754 * 0.5 / 900) * (steps + 6) * vel_0
q_1 = (2 * 3.14 * 1.2754 * 0.5 / 900) * (steps + 6) * vel_1
q_2 = (2 * 3.14 * 1.2754 * 0.5 / 900) * (steps + 6) * vel_2
q_3 = (2 * 3.14 * 1.2754 * 0.5 / 900) * (steps + 6) * vel_3
q_4 = (2 * 3.14 * 1.2754 * 0.5 / 900) * (steps + 6) * vel_4
q_5 = (2 * 3.14 * 1.2754 * 0.5 / 900) * (steps + 6) * vel_5
q_6 = (2 * 3.14 * 1.2754 * 0.5 / 900) * (steps + 6) * vel_6
q_7 = (2 * 3.14 * 1.2754 * 0.5 / 900) * (steps + 6) * vel_7
...
plt.minorticks_on()
fig3.savefig("C:\\Users\\Askar\PycharmProjects\\pythonProject\\graph3.png")
...
plt.minorticks_on()
fig4.savefig("C:\\Users\\Askar\\PycharmProjects\\pythonProject\\graph4.png")
